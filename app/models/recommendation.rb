  ...
  def self.all
    {
      ...
      ['Big', 'Few', 'Traditional'] => Recommendation.new(name: 'Classic 3 burner gas', price: '$199.99', link: 'http://www.lowes.com/pd_404328-82210-463241014_0__?Ntt=commercial+2+burner+gas+grill&UserSearch=commercial+2+burner+gas+grill&productId=50029234&rpp=32', img: 'classic-3-burner.jpg'),
